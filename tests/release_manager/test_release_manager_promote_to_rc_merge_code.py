...
class TestMergeArchivedPatchesToHoProd:
    ...
    def test_successful_merge_single_patch(self, release_manager_with_git):
        ...
        mock_hgit.merge.assert_called_once_with("ho-release/1.3.5/456-user-auth", no_ff=True, m="Integrate patch 456-user-auth")
    ...
    def test_successful_merge_multiple_patches(self, release_manager_with_git):
        ...
        expected_calls = [
            call("ho-release/1.3.5/456-user-auth", no_ff=True, m='Integrate patch 456-user-auth'),
            call("ho-release/1.3.5/789-security", no_ff=True, m='Integrate patch 789-security'),
            call("ho-release/1.3.5/234-reports", no_ff=True, m='Integrate patch 234-reports')
        ]
