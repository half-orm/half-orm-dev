...
class TestGetPatchStructure:
    ...
    def test_get_patch_structure_valid_patch_with_files(self, patch_directory, sample_patch_files):
        ...
        structure = patch_dir.get_patch_structure("456-test")
    ...
    def test_get_patch_structure_empty_patch(self, patch_directory):
        ...
        structure = patch_dir.get_patch_structure("456-empty")
    ...
    def test_get_patch_structure_nonexistent_patch(self, patch_directory):
        """Test analyzing nonexistent patch."""
        patch_dir, repo, temp_dir, schema_patches_dir = patch_directory

        structure = patch_dir.get_patch_structure("999-nonexistent")
    ...
    def test_get_patch_structure_lexicographic_order(self, patch_directory):
        ...
        structure = patch_dir.get_patch_structure("456-order-test")
    ...
    def test_get_patch_structure_mixed_file_types(self, patch_directory):
        ...
        structure = patch_dir.get_patch_structure("456-mixed")
    ...
    def test_get_patch_structure_with_subdirectories(self, patch_directory):
        ...
        structure = patch_dir.get_patch_structure("456-with-dirs")

        # Should only include files, not subdirectories
        assert len(structure.files) == 1
        assert structure.files[0].name == "script.sql"

    def test_get_patch_structure_permission_error(self, patch_directory):
        ...
        try:
            structure = patch_dir.get_patch_structure("456-permission")
    ...
    def test_get_patch_structure_case_insensitive_sorting(self, patch_directory):
        ...
        structure = patch_dir.get_patch_structure("456-case-test")
    ...
    def test_get_patch_structure_unicode_filenames(self, patch_directory):
        ...
        structure = patch_dir.get_patch_structure("456-unicode")
    ...
    def test_get_patch_structure_return_type(self, patch_directory):
        ...
        result = patch_dir.get_patch_structure("456-type-test")
